package com.fh.controller.question.question;
...
public class QuestionController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("question/question/question_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Question页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("question/question/question_edit");
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改Question页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var1", varOList.get(i).getString("OFF_TITLE"));	//1
				vpd.put("var2", varOList.get(i).getString("OFF_CON"));	//2
				varList.add(vpd);
			}
