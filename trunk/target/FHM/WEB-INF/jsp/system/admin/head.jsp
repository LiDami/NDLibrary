<div class="navbar navbar-inverse">
	<div class="navbar-inner">
		<div class="container-fluid" style="background-color: #00a0c6">
			<a class="brand"><small><i class="icon-leaf"></i> 农大图书管理系统</small> </a>
			<%--<span class="nin" style="color:#FFFFFF ;font-size: 20px; display: inline-block">农大图书管理系统</span>--%>
